...
group :production do
	gem "gko_core", "= 0.3.46", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_auth", "= 0.3.46", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_images", "= 0.3.46", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_documents", "= 0.3.46", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_inquiries", "= 0.3.46", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_themes", "= 0.3.46", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_features", "= 0.3.46", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_categories", "= 0.3.46", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_stickers", "= 0.3.46", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_newsletters", "= 0.3.46", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem 'gko_store', '= 0.0.35',  :git => 'git@github.com:jdfdesign/gko_store.git'

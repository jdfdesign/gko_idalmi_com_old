...
group :production do
  gem 'gko_core', '= 0.1.16', :git => 'git@github.com:jdfdesign/gko_cms_rails_3.git'
  ...
  gem 'gko_store', '= 0.0.04',  :git => 'git@github.com:jdfdesign/gko_store.git'
end
...
#  gem "gko_store", :path => File.expand_path('../../gko/gko_store', __FILE__)
